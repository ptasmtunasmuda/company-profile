                ...
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <div class="hidden lg:flex items-center space-x-1">
                        ...
                        <div class="ml-4 pl-4 border-l border-gray-200">
                            <a href="{{ route('contact') }}"
                               class="relative inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white text-sm font-semibold rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg group overflow-hidden">
                                <span class="relative z-10">Get Started</span>
                                <svg class="relative z-10 w-4 h-4 ml-2 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                </svg>
                                <!-- Hover effect -->
                                <div class="absolute inset-0 bg-gradient-to-r from-primary-700 to-primary-800 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-white/95 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl mx-4">
                    <div class="px-6 py-4 space-y-2">
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            <a href="{{ route('contact') }}"
                               class="flex items-center justify-center w-full px-4 py-3 bg-gradient-to-r from-primary-600 to-primary-700 text-white text-base font-semibold rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-300 transform hover:scale-105"
                               @click="open = false">
                                Get Started
