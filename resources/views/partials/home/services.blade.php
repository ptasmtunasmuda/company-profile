<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    @foreach($services as $service)
        <div class="group relative bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-primary-200 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="{{ $service['delay'] }}">
