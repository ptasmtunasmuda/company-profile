    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-20" data-aos="fade-up">
            ...
            <p class="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Project luar biasa yang menunjukkan komitmen kami terhadap keunggulan dan inovasi dalam setiap detail
            </p>
        </div>
                ...
                <div class="group relative" data-aos="fade-up" data-aos-delay="{{ $loop->index * 150 }}">
                    ...
                    <div class="relative bg-white/95 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-3 border border-white/20">
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6 line-clamp-3 text-sm">{{ $portfolio->description }}</p>
                            ...
                            <!-- Bottom accent line -->
                            <div class="mt-6 w-16 h-1 bg-gradient-to-r from-primary-600 to-purple-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        </div>
                    </div>
                </div>
            @endforeach
        ...
        <div class="text-center mt-20" data-aos="fade-up" data-aos-delay="500">
            <div class="bg-gradient-to-r from-gray-50 to-blue-50 rounded-3xl p-8 border border-gray-100 max-w-4xl mx-auto">
                <h3 class="text-2xl font-bold text-gray-900 mb-4">
                    Ingin Proyek Anda Menjadi Unggulan Berikutnya?
                </h3>
                <p class="text-gray-600 mb-6">
                    Mari wujudkan visi digital Anda dengan standar kualitas yang sama seperti proyek-proyek unggulan kami.
                </p>
