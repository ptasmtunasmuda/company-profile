        ...
        <div class="text-center">
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <p class="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-12">
                    Bergabunglah dengan <span class="font-bold text-yellow-300">150+ klien</span> yang telah mempercayai kami untuk
                    <span class="font-bold text-orange-300">{{ strtolower($service['title']) }}</span> yang inovatif dan efektif
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="/portfolio" class="group inline-flex items-center px-10 py-5 bg-transparent border-2 border-white/30 text-white rounded-2xl font-bold text-xl hover:bg-white/10 hover:border-white/50 transition-all duration-500 transform hover:scale-105">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12" data-aos="fade-up" data-aos-delay="400">
                <!-- Email Card -->
                <div class="group bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                    ...
                    <p class="text-blue-100 group-hover:text-white transition-colors duration-300">
                        {{ $contactSettings['contact_email'] ?? 'hello@yourcompany.com' }}
                    </p>
                </div>
                ...
                <div class="group bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                    ...
                    <p class="text-blue-100 group-hover:text-white transition-colors duration-300">
                        {{ $contactSettings['contact_phone'] ?? '+62 812-3456-7890' }}
                    </p>
                </div>
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
                <h3 class="text-2xl font-bold text-white mb-6">
                    Mengapa Memilih {{ $service['title'] }} dari Kami?
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="text-blue-100">Berpengalaman 5+ tahun</span>
                    </div>
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="text-blue-100">Tim ahli bersertifikat</span>
                    </div>
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="text-blue-100">Garansi 100% satisfaction</span>
                    </div>
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="text-blue-100">Support 24/7 setelah launch</span>
                    </div>
                </div>
            </div>
        </div>
