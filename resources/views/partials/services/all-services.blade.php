    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-8 leading-tight">
                Portfolio <span class="bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">Lengkap</span>
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Jelajahi semua layanan yang kami tawarkan untuk kebutuhan digital Anda
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="services-grid">
            @php
                $allServices = [
                    [
                        ...
                        'description' => 'Pengembangan website responsif dengan teknologi modern',
                    ...
                    [
                        ...
                        'description' => 'Pembuatan logo dan identitas visual brand',
            ...
            @foreach($allServices as $index => $service)
                <div class="service-item group relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-primary-200 transform hover:-translate-y-2"
                     data-category="{{ $service['category'] }}"
                     data-aos="fade-up"
                     data-aos-delay="{{ ($index % 3) * 100 + 100 }}">

                    <!-- Service Icon -->
                    <div class="w-14 h-14 bg-gradient-to-br {{ $service['color'] }} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="text-center mt-12" data-aos="fade-up">
            <button id="load-more-services" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-2xl font-semibold hover:from-primary-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
