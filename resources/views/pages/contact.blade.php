...
<section class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div class="text-center p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="text-center p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="text-center p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="500">
    ...
    if (phoneElement) {
        ...
        phoneElement.title = 'Klik untuk menyalin nomor telepon';
    ...
    const mapContainer = document.querySelector('#map-section iframe');
    if (mapContainer) {
    ...
    if (window.location.search.includes('success=1')) {
        ...
        successOverlay.innerHTML = `
            <div class="bg-white rounded-3xl p-8 mx-4 text-center shadow-2xl transform scale-0 transition-transform duration-500">
                ...
                <p class="text-gray-600">Terima kasih telah menghubungi kami. Kami akan membalas dalam 24 jam.</p>
            </div>
        `;
