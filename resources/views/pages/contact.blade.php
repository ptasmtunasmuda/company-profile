    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-12" data-aos="fade-up" data-aos-delay="300">
                Ready to transform your digital presence? Let's discuss your project and bring your <span class="font-semibold text-yellow-300">vision to life</span>
            </p>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="400">
                <div class="text-center">
                    ...
                    <div class="text-blue-200 text-sm font-medium">Response Time</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold text-white mb-2">Free</div>
                    <div class="text-blue-200 text-sm font-medium">Consultation</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl md:text-3xl font-bold text-white mb-2">100%</div>
                    <div class="text-blue-200 text-sm font-medium">Satisfaction</div>
                </div>
                <div class="text-center">
...
<section class="py-24 bg-white relative overflow-hidden">
                ...
                <div data-aos="fade-right">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-8 border border-gray-100 mb-8">
                        <p class="text-lg text-gray-700 leading-relaxed mb-6">
                            Ready to start your project? Contact us today and let's discuss how we can help you achieve your digital goals with cutting-edge solutions.
                        </p>
                        <p class="text-gray-600">
                            We offer free consultation and detailed project estimates. No hidden fees, just transparent communication and exceptional results.
                        </p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group flex items-start p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary-600 transition-colors duration-300">Our Address</h3>
                        ...
                        <div class="group flex items-start p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary-600 transition-colors duration-300">Call Us</h3>
                                <p class="text-gray-600 leading-relaxed">{{ \App\Models\Setting::get('contact_phone', '+62 123-456-7890') }}</p>
                                <p class="text-sm text-gray-500 mt-1">Available 24/7 for urgent inquiries</p>
                            </div>
                        </div>
                        ...
                        <div class="group flex items-start p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary-600 transition-colors duration-300">Email Us</h3>
                        ...
                        <div class="group flex items-start p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-primary-600 transition-colors duration-300">Office Hours</h3>
                                <p class="text-gray-600 leading-relaxed">{{ \App\Models\Setting::get('office_hours', 'Monday - Friday: 09:00 - 17:00') }}</p>
                                <p class="text-sm text-gray-500 mt-1">Weekend consultations by appointment</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                                <div class="flex items-center justify-center">
                                    ...
                                    <span class="text-sm text-gray-600">Free Consultation</span>
                                </div>
                                <div class="flex items-center justify-center">
                                    <svg class="w-5 h-5 text-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-sm text-gray-600">Quick Response</span>
                                </div>
                                <div class="flex items-center justify-center">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20" data-aos="fade-up">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Here are some common questions we get from our clients. Can't find what you're looking for? Feel free to contact us!</p>
        </div>
        ...
        <div class="space-y-6" x-data="{ activeAccordion: null }">
            ...
            <div class="group bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                <button @click="activeAccordion = activeAccordion === 1 ? null : 1"
                    ...
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300">How long does it take to develop a website?</h3>
                ...
                <div x-show="activeAccordion === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" class="px-8 pb-6">
                    <div class="bg-gradient-to-r from-primary-50 to-blue-50 rounded-2xl p-6 border-l-4 border-primary-500">
                        <p class="text-gray-700 leading-relaxed">The development timeline depends on the complexity and features of your website. A simple business website typically takes 2-4 weeks, while a complex web application can take 2-6 months. We'll provide you with a detailed timeline during our initial consultation, including milestones and deliverables.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                <button @click="activeAccordion = activeAccordion === 2 ? null : 2"
                        class="w-full px-8 py-6 text-left flex justify-between items-center focus:outline-none hover:bg-gray-50 transition-colors duration-300">
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300">What is included in your development services?</h3>
                    <div class="flex-shrink-0 ml-6">
                        <div class="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 transition-colors duration-300">
                ...
                <div x-show="activeAccordion === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" class="px-8 pb-6">
                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border-l-4 border-green-500">
                        <p class="text-gray-700 leading-relaxed">Our comprehensive services include initial consultation, UI/UX design, frontend and backend development, database design, testing, deployment, and post-launch support. We also provide training for content management, SEO optimization, and basic maintenance guidance to ensure your success.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                <button @click="activeAccordion = activeAccordion === 3 ? null : 3"
                        class="w-full px-8 py-6 text-left flex justify-between items-center focus:outline-none hover:bg-gray-50 transition-colors duration-300">
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300">Do you provide ongoing maintenance and support?</h3>
                    <div class="flex-shrink-0 ml-6">
                        <div class="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 transition-colors duration-300">
                ...
                <div x-show="activeAccordion === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" class="px-8 pb-6">
                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border-l-4 border-purple-500">
                        <p class="text-gray-700 leading-relaxed">Yes, we offer various maintenance packages including security updates, content updates, performance monitoring, backup management, and 24/7 technical support. We also provide 30 days of free support after project completion to ensure everything runs smoothly.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="400">
                <button @click="activeAccordion = activeAccordion === 4 ? null : 4"
                        class="w-full px-8 py-6 text-left flex justify-between items-center focus:outline-none hover:bg-gray-50 transition-colors duration-300">
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300">What are your payment terms?</h3>
                    <div class="flex-shrink-0 ml-6">
                        <div class="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 transition-colors duration-300">
                ...
                <div x-show="activeAccordion === 4" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" class="px-8 pb-6">
                    <div class="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-6 border-l-4 border-orange-500">
                        <p class="text-gray-700 leading-relaxed">We typically require 50% upfront payment to begin the project, with the remaining 50% due upon completion. For larger projects, we can arrange milestone-based payments. We accept bank transfers, credit cards, and various online payment methods for your convenience.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="500">
                <button @click="activeAccordion = activeAccordion === 5 ? null : 5"
                        class="w-full px-8 py-6 text-left flex justify-between items-center focus:outline-none hover:bg-gray-50 transition-colors duration-300">
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300">Can you help with mobile app development?</h3>
                    <div class="flex-shrink-0 ml-6">
                        <div class="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 transition-colors duration-300">
                ...
                <div x-show="activeAccordion === 5" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" class="px-8 pb-6">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border-l-4 border-blue-500">
                        <p class="text-gray-700 leading-relaxed">Absolutely! We specialize in both native and cross-platform mobile app development using React Native and Flutter. We can develop apps for iOS and Android platforms and help with app store submissions, optimization, and ongoing updates.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-16" data-aos="fade-up" data-aos-delay="600">
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-100">
                ...
                <p class="text-gray-600 mb-6">Can't find the answer you're looking for? Our team is here to help you with any specific questions about your project.</p>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-8 leading-tight">
                Visit Our <span class="bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">Office</span>
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Come visit us at our office for a face-to-face consultation or schedule a virtual meeting at your convenience.</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl overflow-hidden shadow-2xl h-96 md:h-[500px] relative group" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="w-full h-full flex items-center justify-center text-gray-500 bg-gradient-to-br from-blue-50 to-purple-50">
                <div class="text-center p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Interactive Map Coming Soon</h3>
