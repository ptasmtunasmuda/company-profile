    ...
    <div class="admin-card">
        ...
        @if($testimonials->count() > 0)
            <div class="overflow-x-auto admin-scrollbar">
                <table class="admin-table"><thead><tr><th>Client</th>
                            <th>Testimonial</th>
                            <th>Rating</th>
                            <th>Status</th>
                            <th>Created</th>
                            ...
                            <tr class="hover:">
                                ...
                                <td class="text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('admin.testimonials.show', $testimonial) }}" class="text-gray-600 hover:text-gray-700 p-1 rounded admin-transition" title="View Testimonial">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                            </svg>
                                        </a>
                                        <a href="{{ route('admin.testimonials.edit', $testimonial) }}" class="text-blue-600 hover:text-blue-700 p-1 rounded admin-transition" title="Edit Testimonial">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <form action="{{ route('admin.testimonials.destroy', $testimonial) }}" method="POST" class="inline" data-confirm-delete="Are you sure you want to delete this testimonial?">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-700 p-1 rounded admin-transition" title="Delete Testimonial">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
