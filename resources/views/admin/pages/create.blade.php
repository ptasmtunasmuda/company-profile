...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.pages.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
        ...
        <form action="{{ route('admin.pages.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title') }}"
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('meta_title') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" name="meta_description" rows="3"
                                  ...
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('meta_description') border-red-500 @enderror">{{ old('meta_description') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords') }}"
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('meta_keywords') border-red-500 @enderror">
            ...
            <div>
                ...
                <div class="mt-2 flex justify-between items-center">
                    ...
                    <button type="button" onclick="togglePreview()" class="text-sm text-primary-600 hover:text-primary-700">
                        Toggle Preview
                    </button>
                </div>
                @error('content')
