...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.pages.create') }}" class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="text-2xl font-bold text-green-600">{{ $pages->where('is_active', true)->count() }}</div>
            <div class="text-sm text-gray-600">Published Pages</div>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
            <div class="text-2xl font-bold text-gray-600">{{ $pages->where('is_active', false)->count() }}</div>
    ...
    <div class="bg-white shadow rounded-lg">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="{{ route('admin.pages.edit', $page) }}" class="text-primary-600 hover:text-primary-900">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">No pages</h3>
